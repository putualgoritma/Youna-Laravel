...
return [
    ...
    'availability' => [
        ...
        'fields' => [
            'id' => 'ID',
            'id_helper' => '',
            'clinic_id' => 'Nama Klinik',
            'clinic_id_helper' => '',
            'customer_id' => 'Nama Expert',
            'customer_id_helper' => '',
            'day_id' => 'Hari',
            'day_id_helper' => '',
            'start' => 'Mulai',
    ...
    'availability_close' => [
        ...
        'fields' => [
            'id' => 'ID',
            'id_helper' => '',
            'availability_id' => 'Jadwal Klinik',
            'availability_id_helper' => '',
            'date' => 'Tanggal Libur',
            'date_id_helper' => '',
        ],
    ],
    'order_availability' => [
        ...
        'fields' => [
            'id' => 'ID',
            'id_helper' => '',
            'availability_id' => 'Jadwal Konsultasi',
            'availability_id_helper' => '',
    ...
    'clinic_customer' => [
        ...
        'fields' => [
            ...
            'code' => 'Kode',
            'code_helper' => '',
            'expert_code' => 'Kode Expert',
            'expert_code_helper' => '',
            'expert_name' => 'Nama Expert',
            'expert_name_helper' => '',
        ],
    ],
];
