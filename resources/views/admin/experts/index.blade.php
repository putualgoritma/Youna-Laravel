    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.experts.create") }}">
                {{ trans('global.add') }} {{ trans('global.expert.title_singular') }}
            </a>
        </div>
    </div>
@endcan
...
<div class="card">
    <div class="card-header">
        {{ trans('global.expert.title_singular') }} {{ trans('global.list') }}
    </div>
            ...
            <table class=" table table-bordered table-striped table-hover datatable ajaxTable datatable-customers">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('global.expert.fields.code') }}
                        </th>
                        <th>
                            {{ trans('global.expert.fields.register') }}
                        </th>
                        <th>
...
<script>
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.experts.massDestroy') }}",
