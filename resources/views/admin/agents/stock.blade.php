...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    "footerCallback": function ( row, data, start, end, display ) {
        ...
        $( api.column( 5 ).footer() ).html(Totaldebit.toLocaleString("en-GB"));
        $( api.column( 6 ).footer() ).html(Totalcredit.toLocaleString("en-GB"));
        $( api.column( 7 ).footer() ).html(Total.toLocaleString("en-GB"));
        },
  };
